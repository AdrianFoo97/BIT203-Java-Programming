...
/**
 * This class will create a form for the trainer to create a new group training
 * session
 * @author foo
 */
public class NewGroupTrainingSession extends javax.swing.JDialog {
    private Trainer theTrainer;
    private HELPFit HF;
    int xMouse;
    int yMouse;
    /**
     * This is the constructor that creates a form for the trainer to 
     * create a new group training session
     */
    public NewGroupTrainingSession(java.awt.Frame parent, boolean modal, 
            Trainer theTrainer) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        classTypeCombo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "MMA", "SPORT", "DANCE" }));
        jPanel1.add(classTypeCombo, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 470, 325, 40));
        ...
        jPanel1.add(titleTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 60, 325, 30));

        dateTF.setBackground(new java.awt.Color(36, 49, 67));
        dateTF.setForeground(new java.awt.Color(255, 255, 255));
        dateTF.setBorder(null);
        jPanel1.add(dateTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 140, 325, 30));

        feeTF.setBackground(new java.awt.Color(36, 49, 67));
        feeTF.setForeground(new java.awt.Color(255, 255, 255));
        feeTF.setBorder(null);
        jPanel1.add(feeTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 300, 325, 30));
        ...
        jPanel1.add(createBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 540, 102, 40));
        ...
        jLabel6.setText("Max number of participants: ");
        ...
        maxParticipantsTF.setBackground(new java.awt.Color(36, 49, 67));
        maxParticipantsTF.setForeground(new java.awt.Color(255, 255, 255));
        maxParticipantsTF.setBorder(null);
        jPanel1.add(maxParticipantsTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 380, 325, 30));
        ...
        jPanel1.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 410, 320, 10));
        jPanel1.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 90, 320, 10));
        jPanel1.add(jSeparator4, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 170, 320, 10));
        jPanel1.add(jSeparator5, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 250, 320, 10));
        jPanel1.add(jSeparator6, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 330, 320, 10));

        timeTF.setBackground(new java.awt.Color(36, 49, 67));
        timeTF.setForeground(new java.awt.Color(255, 255, 255));
        timeTF.setBorder(null);
        jPanel1.add(timeTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 220, 320, 30));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 190, 450, 610));
        ...
        jLabel1.setText("New Group Training");
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 130, -1, -1));

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fitnessApp/img/People_96px.png"))); // NOI18N
        ...
        jPanel2.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 10, 30, -1));

        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 450, 190));
        getContentPane().add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 200, 330, 10));
        ...
        getContentPane().add(frameDrag, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 450, 40));
    ...
    /**
     * This function will create a new group training session by using HELPFit
     * controller when all the details entered is valid
     * @param evt 
     */
    private void createBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createBtnActionPerformed
        GroupTraining theSession = null;
        String[] options = {"OK"};
        ...
        boolean validPartNum = false;
        
        if (title.equals("") || dateTF.equals("") || timeTF.getText().equals("") ||
                feeTF.getText().equals("") || maxParticipantsTF.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Please fill in the details required!");
            
        }
        else {
            tt = TrainingType.valueOf
            ((String)classTypeCombo.getSelectedItem());
            ...
            try {
                maxParticipants = Integer.parseInt(maxParticipantsTF.getText());
                validPartNum = true;
            } catch (NumberFormatException nfe) {
                JOptionPane.showMessageDialog(this, "Please enter a number, "
            ...
            if (validDate && validTime && validFee && validPartNum) {
                theSession = theTrainer.addGroupTraining(title, sessionDate, 
                        sessionTime, fee, tt, maxParticipants); 
                if (theSession != null){
    ...
    private javax.swing.JComboBox<String> classTypeCombo;
